...
crate::gpio::gpio! {
    ...
    (4, 0, InputOutputAnalogTouch)
    (5, 0, InputOutputAnalogTouch)
    (6, 0, InputOutputAnalogTouch)
    (7, 0, InputOutputAnalogTouch)
    (8, 0, InputOutputAnalogTouch () (3 => SUBSPICS1))
    (9, 0, InputOutputAnalogTouch (3 => SUBSPIHD 4 => FSPIHD) (3 => SUBSPIHD 4 => FSPIHD))
    (10, 0, InputOutputAnalogTouch (2 => FSPIIO4 4 => FSPICS0) (2 => FSPIIO4 3 => SUBSPICS0 4 => FSPICS0))
    (11, 0, InputOutputAnalogTouch (2 => FSPIIO5 3 => SUBSPID 4 => FSPID) (2 => FSPIIO5 3 => SUBSPID 4 => FSPID))
    (12, 0, InputOutputAnalogTouch (2 => FSPIIO6 4 => FSPICLK) (2 => FSPIIO6 3=> SUBSPICLK 4 => FSPICLK))
    (13, 0, InputOutputAnalogTouch (2 => FSPIIO7 3 => SUBSPIQ 4 => FSPIQ) (2 => FSPIIO7 3 => SUBSPIQ 4 => FSPIQ))
    (14, 0, InputOutputAnalogTouch (3 => SUBSPIWP 4 => FSPIWP) (2 => FSPIDQS 3 => SUBSPIWP 4 => FSPIWP))
...
crate::gpio::touch_into! {
    // (touch_nr, pin_nr, rtc_pin, touch_comb_reg_nr, normal_pin)
     ( 1,  1,  1,  sar_touch_thres1,  sar_touch_out_th1, true )
     ( 2,  2,  2,  sar_touch_thres2,  sar_touch_out_th2, true )
     ( 3,  3,  3,  sar_touch_thres3,  sar_touch_out_th3, true )
     ( 4,  4,  4,  sar_touch_thres4,  sar_touch_out_th4, true )
     ( 5,  5,  5,  sar_touch_thres5,  sar_touch_out_th5, true )
     ( 6,  6,  6,  sar_touch_thres6,  sar_touch_out_th6, true )
     ( 7,  7,  7,  sar_touch_thres7,  sar_touch_out_th7, true )
     ( 8,  8,  8,  sar_touch_thres8,  sar_touch_out_th8, true )
     ( 9,  9,  9,  sar_touch_thres9,  sar_touch_out_th9, true )
     (10, 10, 10, sar_touch_thres10, sar_touch_out_th10, true )
     (11, 11, 11, sar_touch_thres11, sar_touch_out_th11, true )
     (12, 12, 12, sar_touch_thres12, sar_touch_out_th12, true )
     (13, 13, 13, sar_touch_thres13, sar_touch_out_th13, true )
     (14, 14, 14, sar_touch_thres14, sar_touch_out_th14, true )
     ---
}

crate::gpio::touch_common! {
    // (touch_nr, pin_nr, touch_comb_reg_nr )
     ( 1,  1,  sar_touch_status1,  sar_touch_pad1_data,  sar_touch_thres1,  sar_touch_out_th1)
     ( 2,  2,  sar_touch_status2,  sar_touch_pad2_data,  sar_touch_thres2,  sar_touch_out_th2)
     ( 3,  3,  sar_touch_status3,  sar_touch_pad3_data,  sar_touch_thres3,  sar_touch_out_th3)
     ( 4,  4,  sar_touch_status4,  sar_touch_pad4_data,  sar_touch_thres4,  sar_touch_out_th4)
     ( 5,  5,  sar_touch_status5,  sar_touch_pad5_data,  sar_touch_thres5,  sar_touch_out_th5)
     ( 6,  6,  sar_touch_status6,  sar_touch_pad6_data,  sar_touch_thres6,  sar_touch_out_th6)
     ( 7,  7,  sar_touch_status7,  sar_touch_pad7_data,  sar_touch_thres7,  sar_touch_out_th7)
     ( 8,  8,  sar_touch_status8,  sar_touch_pad8_data,  sar_touch_thres8,  sar_touch_out_th8)
     ( 9,  9,  sar_touch_status9,  sar_touch_pad9_data,  sar_touch_thres9,  sar_touch_out_th9)
     (10, 10, sar_touch_status10, sar_touch_pad10_data, sar_touch_thres10, sar_touch_out_th10)
     (11, 11, sar_touch_status11, sar_touch_pad11_data, sar_touch_thres11, sar_touch_out_th11)
     (12, 12, sar_touch_status12, sar_touch_pad12_data, sar_touch_thres12, sar_touch_out_th12)
     (13, 13, sar_touch_status13, sar_touch_pad13_data, sar_touch_thres13, sar_touch_out_th13)
     (14, 14, sar_touch_status14, sar_touch_pad14_data, sar_touch_thres14, sar_touch_out_th14)
}
